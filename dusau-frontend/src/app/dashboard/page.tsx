...
//     async function run() {
//       try {
//         const [committees, events, alumni, advisors, gallery, members] = await Promise.all([
//           adminJson<any[]>('/api/admin/committees'),
//           adminJson<any[]>('/api/admin/events'),
//           adminJson<any[]>('/api/admin/alumni'),
//           adminJson<any[]>('/api/admin/advisors'),
//           adminJson<any[]>('/api/admin/gallery'),
//           adminJson<any[]>('/api/admin/member-directory'),
//         ])
...
//           { title: 'Member Directory', value: String(members.length), href: '/dashboard/member-directory' },
//         ])
//       } catch (error) {
...
//             <p className="mt-3 text-sm leading-7 text-slate-300">Click below to manage this section.</p>
